    ...
    <style>
        ...
        * {
        ...
        .background-overlay {
            ...
            width: 100%;
            height: 100%;
            background-image: url('https://i.postimg.cc/6pSr3yBg/3.jpg');
...
<body>
        ...
        <ul class="menu">
            ...
            <li class="menu-item has-submenu">
                <a href="#" class="menu-link" aria-expanded="false">
                    ...
                    <span class="menu-text">Operations & Warning</span>
                </a>
                <ul class="submenu">
                    <li class="menu-item">
                        <a href="WTDTTB.php" class="menu-link">
                            <i class="fas fa-cloud-sun-rain"></i>
                            <span class="menu-text">Weather Report</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="IncidentDataTable.php" class="menu-link">
                            <i class="fas fa-ambulance"></i>
                            <span class="menu-text">Incident Report</span>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="dispatch.php" class="menu-link">
                            <i class="fas fa-automobile"></i>
            ...
            <li class="menu-item has-submenu">
                ...
                <ul class="submenu">
                    <li class="menu-item">
                        <a href="dispatchback.php" class="menu-link">
                            <i class="fas fa-table"></i>
                            <span class="menu-text">Datatable</span>
                        </a>
                    </li>
    ...
    <div class="main-content">
        ...
        <p>You are logged in. Use the sidebar to navigate.</p>
    </div>
